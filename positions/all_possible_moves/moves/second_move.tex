\begin{tikzpicture}
    ...
    \node(c4) [circle, draw, minimum size = \size cm, fill = red!40] at (\d * 0,-\d*2) {\tiny i+d2};
    ...
    (c1) edge [bend left=45] node[pos=0.7, right, rectangle, draw, minimum width = 0.75 cm, minimum height = 0.75 cm, rounded corners, line width = 0.1 cm, xshift=0.1cm, yshift=-0.2cm] {d2} (c4)
